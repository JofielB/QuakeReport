...
public class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String sUrl) {
    ...
    //MAKES THE HTTP REQUEST WITH THE URL OBJECT AND RETURN THE JSON
    private static String makeHttpRequest(URL url) throws IOException {

        String jsonResponse = "";
        //If the url its null we do not do anything
        if(url == null){
            return jsonResponse;
        }
        ...
        try {
            ...
            //Check that the response was a valid one
            ...
            Log.d(LOG_TAG,"Exception error: " + e);
